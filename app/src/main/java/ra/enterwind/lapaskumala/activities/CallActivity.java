...
public class CallActivity extends BaseCallActivity implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        Picasso.with(CallActivity.this).load(foto).fit().into(portrait);
        TextView nama = findViewById(R.id.getNama);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.accept_call_btn:
                ...
                Toast.makeText(this, "Angkat", Toast.LENGTH_SHORT).show();
                break;
            case R.id.hang_up_btn:
                if (isCaller()) {
                    cancelLocalInvitation();
                    Toast.makeText(this, "Matu", Toast.LENGTH_SHORT).show();
                } else if (isCallee()) {
    ...
    @OnClick(R.id.accept_call_btn) void onAngkat(){
        Toast.makeText(this, "Angkat", Toast.LENGTH_SHORT).show();
    }

    @OnClick(R.id.hang_up_btn) void onMati(){
        Toast.makeText(this, "Matu", Toast.LENGTH_SHORT).show();
    }
